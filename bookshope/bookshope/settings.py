"""
Django settings for bookshope project.
...
SECRET_KEY = 'django-insecure-1ff3fvjjsmp$y0g5o)_t6cc*u3e-=8_thj_gd^pir+cy@b+&5c'
...
WSGI_APPLICATION = 'bookshope.wsgi.application'
